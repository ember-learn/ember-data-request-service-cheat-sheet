...
default:return _.clientBuilder.bind(null)}}}),e.register(E.privatize`template:-root`,S),e.register("renderer:-dom",hr)},e.setupEngineRegistry=function(e){e.optionsForType("template",{instantiate:!1}),e.register("view:-outlet",or),e.register("template:-outlet",fr),e.optionsForType("helper",{instantiate:!1}),e.register("component:input",J),e.register("component:link-to",me),e.register("component:textarea",be),w.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS||e.register(E.privatize`component:-default`,Je)},Object.defineProperty(e,"template",{enumerable:!0,get:function(){return t.templateFactory}}),Object.defineProperty(e,"templateCacheCounters",{enumerable:!0,get:function(){return t.templateCacheCounters}})
...
return t=(0,a.isInvokableRef)(o)?je(o,o,Ae,d,u):function(e,t,r,n,i){0
...
function Se(e){return e}function je(e,t,r,n,i){var o,a
...
class St{constructor(e,t){this.owner=e,this.isInteractive=t,this.enableDebugTooling=w.ENV._DEBUG_RENDER_TREE}onTransactionCommit(){}}var jt=Ce((e=>{var{positional:t,named:r}=e,n=t[0],i=r.type,o=r.loc,s=r.original;(0,a.valueForRef)(i),(0,a.valueForRef)(o),(0,a.valueForRef)(s)
...
Object.defineProperty(e,"__esModule",{value:!0}),e.TrackedDescriptor=e.SYNC_OBSERVERS=e.PROXY_CONTENT=e.PROPERTY_DID_CHANGE=e.NAMESPACES_BY_ID=e.NAMESPACES=e.Mixin=e.Libraries=e.DEBUG_INJECTION_FUNCTIONS=e.ComputedProperty=e.ASYNC_OBSERVERS=void 0,e._getPath=Pe,e._getProp=Ce,e._setProp=je,e.activateObserver=k,e.addArrayObserver=function(e,t,r){return W(e,t,r,m)},e.addListener=m,e.addNamespace=function(e){$e.unprocessedNamespaces=!0,Ge.push(e)},e.addObserver=O,e.alias=function(e){return oe(new Ie(e),Me)},e.applyMixin=ut,e.arrayContentDidChange=q,e.arrayContentWillChange=B,e.autoComputed=function(){for(var e=arguments.length,t=new Array(e),r=0;r<e;r++)t[r]=arguments[r]
return oe(new ge(t),ve)},e.beginPropertyChanges=L,e.cached=void 0,e.changeProperties=z,e.computed=be,Object.defineProperty(e,"createCache",{enumerable:!0,get:function(){return s.createCache}}),e.defineProperty=ye,e.deprecateProperty=function(e,t,r,n){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set(e){Se(this,r,e)},get(){return xe(this,r)}})},e.descriptorForDecorator=le,e.descriptorForProperty=se,e.eachProxyArrayDidChange=function(e,t,r,n){var i=Fe.get(e)
...
Array.isArray(e)?G(e,t,r,n):e.replace(t,r,n)},e.replaceInNativeArray=G,e.sendEvent=g,e.set=Se,e.setClassicDecorator=ce,e.setNamespaceSearchDisabled=function(e){Ve=Boolean(e)},e.setProperties=function(e,t){if(null===t||"object"!=typeof t)return t
return z((()=>{var r=Object.keys(t)
for(var n of r)Se(e,n,t[n])})),t},e.tagForObject=function(e){if((0,r.isObject)(e))return(0,s.tagFor)(e,A)
return s.CONSTANT_TAG},e.tagForProperty=M,e.tracked=gt,e.trySet=function(e,t,r){return Se(e,t,r,!0)}
...
e.forEach(((e,i)=>{if(!e.suspended&&!(0,s.validateTag)(e.tag,e.lastRevision))try{e.suspended=!0,g(r,i,[r,e.path],void 0,n)}finally{e.tag=J(r,e.path,(0,s.tagMetaFor)(r),(0,t.peekMeta)(r)),e.lastRevision=(0,s.valueForTag)(e.tag),e.suspended=!1}}))}))}function j(e,t,r){var n=y.get(e)
...
null!==o&&(o.isInitializing()||o.isPrototypeMeta(e))||(I(e,r),D<=0&&S(),N in e&&(4===arguments.length?e[N](r,i):e[N](r)))}function L(){D++,T=!0}function U(){--D<=0&&(S(),function(){for(var[e,t,r]of(T=!1,x))C(e,t,r)
x=[]}())}function z(e){L()
...
j(e,t,!0)
try{i=s.call(e,t,r,a)}finally{j(e,t,!1)}return o&&a===i||(n.setValueFor(t,i),F(e,t,n,r)),i}teardown(e,t,r){void 0!==r.revisionFor(t)&&(r.setRevisionFor(t,void 0),r.setValueFor(t,void 0)),super.teardown(e,t,r)}}e.ComputedProperty=fe
...
var Re={}
function Se(e,t,r,n){return e.isDestroyed?r:Ee(t)?Ae(e,t,r,n):je(e,t,r)}function je(e,t,n){var i,o=(0,r.lookupDescriptor)(e,t)
...
return(i=n.into?j(e,n.into):t)?(0,r.set)(i.outlets,n.outlet,o):e=o,{liveRoutes:e,ownState:o}}function M(e,t,r){var{routeName:n}=r,i=j(e,n)
...
var n=w.get(e)
return void 0!==n&&w.set(r,n),r}var{toString:x}=Object.prototype,{toString:C}=Function.prototype,{isArray:P}=Array,{keys:R}=Object,{stringify:S}=JSON,j=100,A=/^[\w$]+$/
...
break}var a=i[o]
n+=`${I(a)}: ${M(e[a],t,r)}`}return n+=" }"}(e,r+1,n)}function I(e){return A.test(e)?e:S(e)}function N(e,t){var r=e
...
0
return A.set(t,e),t},e.setCustomTagFor=v,e.setHelperManager=function(e,t){return p(new j(e),t)},e.setInternalComponentManager=h,e.setInternalHelperManager=p,e.setInternalModifierManager=d,e.setModifierManager=function(e,t){return d(new P(e),t)}
...
!0===o.disableAutoTracking?(0,n.untrack)((()=>i.updateModifier(r,t))):i.updateModifier(r,t)}getDestroyable(e){return e}}function R(e){return e.capabilities.hasValue}function S(e){return e.capabilities.hasDestroyable}e.CustomModifierManager=P
...
return S(o)&&(0,i.associateDestroyableChild)(l,o.getDestroyable(s)),l}if(S(o)){var u=(0,r.createConstRef)(void 0,!1)
...
"number"==typeof n&&(n=(0,t.isSmallInt)(n)?(0,t.encodeImmediate)(n):{type:6,value:n}),e(30,n)}function S(e,t,n,i){e(0),k(e,n,i,!1),e(16,t),e(1),e(36,r.$v0)}function j(e,t,n,i){e(0),k(e,t,n,!1),e(33,r.$fp,1),e(107),i?(e(36,r.$v0),i(),e(1),e(34,1)):(e(1),e(34,1),e(36,r.$v0))}function A(e,t,r){k(e,r,null,!0),e(23,t),e(24),e(61),e(64),e(40),e(1)}function M(e,t){(function(e,t){null!==t?e(63,d({parameters:t})):R(e,null)})(e,t&&t[1]),e(62),D(e,t)}function I(e,t){e(0),D(e,t),e(61),e(2),e(1)}function N(e,t,n){var i=t[1],o=i.length,a=Math.min(n,o)
...
g(r)?e(1005,r,(t=>{S(e,t,n,i)})):(E(e,r),j(e,n,i))})),O.add(50,((e,t)=>{var[,n,i,o,a]=t;(function(e,t,n,i,o){e(0),k(e,i,o,!1),e(86),E(e,n),e(77,t,{type:2,value:void 0}),e(1),e(36,r.$v0)})(e,i,n,o,a)})),O.add(30,((e,t)=>{var[,r,n]=t
e(21,r),w(e,n)})),O.add(32,((e,t)=>{var[,r,n]=t
e(1011,r,(t=>{e(29,t),w(e,n)}))})),O.add(31,((e,t)=>{var[,r,n]=t
e(1009,r,(e=>{}))})),O.add(34,(()=>{throw new Error("unimplemented opcode")})),O.add(36,((e,t)=>{e(1010,t[1],(r=>{e(1006,t,{ifHelper:t=>{S(e,t,null,null)}})}))})),O.add(99,((e,t)=>{e(1010,t[1],(r=>{e(1006,t,{ifHelper:(r,n,i)=>{t[2][0]
S(e,r,null,null)}})}))})),O.add(27,(e=>P(e,void 0))),O.add(48,((e,t)=>{var[,r]=t
...
E(e,x[C]),f.push(P)}}e(82,k,t.EMPTY_STRING_ARRAY,w),f.push(-1)}else if(null!==u)for(var R=u[0],S=u[1],j=0;j<S.length;j++){var A=R[j],I=h.indexOf(A);-1!==I&&(E(e,S[j]),f.push(I),g.push(A))}e(97,r.$s0),(0,i.hasCapability)(o,64)&&e(59);(0,i.hasCapability)(o,512)&&e(87,0|c.has("default"),r.$s0)
...
v(n)?e(1007,n,{ifComponent(t){B(e,t,null,i,X(o),null)},ifHelper(t){e(0),S(e,t,i,o),e(3,c("cautious-non-dynamic-append")),e(1)}}):F(e,(()=>{E(e,n),e(106)}),(t=>{t(0,(()=>{e(81),e(79),V(e,{capabilities:!0,elementBlock:null,positional:i,named:o,atNames:!1,blocks:l(null)})})),t(1,(()=>{j(e,i,o,(()=>{e(3,c("cautious-non-dynamic-append"))}))}))}))}else e(0),E(e,r),e(3,c("cautious-append")),e(1)
...
if((0,s.hasDestroyable)(c)){var h=c.getDestroyable(p);(0,i.associateDestroyableChild)(l,h)}return l},Object.defineProperty(e,"isDestroyed",{enumerable:!0,get:function(){return i.isDestroyed}}),Object.defineProperty(e,"isDestroying",{enumerable:!0,get:function(){return i.isDestroying}}),e.isSerializationFirstNode=function(e){return e.nodeValue===Qt},e.isWhitespace=function(e){return _t.test(e)},e.normalizeProperty=S,e.on=void 0,Object.defineProperty(e,"registerDestructor",{enumerable:!0,get:function(){return i.registerDestructor}}),e.rehydrationBuilder=function(e,t){return Xt.forInitialRender(e,t)},e.reifyArgs=Ie,e.reifyNamed=Ae,e.reifyPositional=Me,e.renderComponent=function(e,n,i,o,a,s,l){void 0===s&&(s={})
void 0===l&&(l=new d)
...
i=o}}function T(e){return x(e)?"":String(e)}function x(e){return null==e||"function"!=typeof e.toString}function C(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function P(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function R(e){return"string"==typeof e}function S(e,t){var r,n,i,o,a
...
l.setup(i,S,E,P,!1)}i.push(l)}else i.push(l)})),ce.add(87,((e,t)=>{var{op1:r,op2:n}=t,i=e.fetchValue(n),{definition:o,manager:a,capabilities:l}=i
...
this.runtime=e,this.elementStack=n,this.context=i,this[St]=new Ht,this[jt]=new t.Stack,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null,this.resume=Yt(this.context)
...
0
return r},e.createTag=function(){return new g(0)},e.createUpdatableTag=y,e.dirtyTag=void 0,e.dirtyTagFor=j,e.endTrackFrame=L,e.endTrackingTransaction=void 0,e.endUntrackFrame=z,e.getValue=function(e){G(e,"getValue")
var t=e[q],r=e[$],n=e[H]
...
return B(M(i,e)),n&&!r.has(i)?(o=t.call(i),r.set(i,o)):o=r.get(i),o},setter:function(t,n){j(t,e),r.set(t,n)}}},e.untrack=function(e){U()
...
if(void 0!==n){var i=n.get(t)
void 0!==i&&v(i,!0)}}function A(e){var t=S.get(e)
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=v(...arguments),void 0===n?i=0:a(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,_=0,O=0,w=0,E=0,k=0,T=0,x=0,C=0,P=0,R=0,S=0,j=0,A=0,M=0,I=0,N=0,D=0,F=0,L=0,U=0
...
for(var t=arguments.length,r=new Array(t>1?t-1:0),n=1;n<t;n++)r[n-1]=arguments[n]
var[i,o,a]=v(...r),s=this.DEBUG?new Error:void 0
return this._ensureInstance().schedule(e,i,o,a,!0,s)}setTimeout(){return S++,this.later(...arguments)}later(){j++
...
return t||(t=e._promiseCallbacks={}),t}Object.defineProperty(e,"__esModule",{value:!0}),e.Promise=e.EventTarget=void 0,e.all=j,e.allSettled=M,e.asap=Q,e.cast=e.async=void 0,e.configure=o,e.default=void 0,e.defer=z,e.denodeify=P,e.filter=W,e.hash=D,e.hashSettled=L,e.map=q,e.off=fe,e.on=me,e.race=I,e.reject=$,e.resolve=V,e.rethrow=U
...
return n[r]=function(e,r){e?f(l,e):void 0===t?p(l,r):!0===t?p(l,x(arguments)):Array.isArray(t)?p(l,T(arguments,t)):p(l,r)},i?S(l,n,e,this):R(l,n,e,this)}
return r.__proto__=e,r}function R(e,t,r,n){try{r.apply(n,t)}catch(i){f(e,i)}return e}function S(e,t,r,n){return k.all(t).then((t=>R(e,t,r,n)))}function j(e,t){return k.all(e,t)}e.Promise=k,k.cast=l,k.all=function(e,t){return Array.isArray(e)?new _(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},k.race=function(e,t){var r=new this(u,t)
...
for(var ve in o("instrument",!0),ge)ge.hasOwnProperty(ve)&&me(ve,ge[ve])}var be={asap:Q,cast:pe,Promise:k,EventTarget:n,all:j,allSettled:M,race:I,hash:D,hashSettled:L,rethrow:U,defer:z,denodeify:P,configure:o,on:me,off:fe,resolve:V,reject:$,map:q,async:he,filter:W}
